...
const Hero = () => {
  ...
  // ملف CV مؤقت - يمكنك استبداله بملف حقيقي
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-r from-purple-500/10 to-cyan-500/10 rounded-full filter blur-3xl animate-spin-slow" />
      </div>
